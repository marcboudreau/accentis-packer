...
# CIS 1.1.2
(
    [ "$(mount | grep '\s/tmp\s')" = "tmpfs on /tmp type tmpfs (rw,nosuid,nodev,noexec,relatime)" ]
...
# CIS 1.1.6
(
    [ "$(mount | grep -E '\s/dev/shm\s')" = "tmpfs on /dev/shm type tmpfs (rw,nosuid,nodev,noexec,relatime)" ]
